...
class Settings(BaseSettings):
    ...
    wb_proxy_timeout_seconds: float = 10.0
    ...
    ozon_browser_scroll_rounds: int = 1
    ozon_browser_scroll_pause_seconds: float = 0.35
    ...
    other_max_results: int = 15
    search_max_results_per_source: int = 15
